...
void* shm_stream_read(void* param)
{
	...
	shm_stream_t* handle = shm_stream_create("read_th", "stream", STREAM_MAX_USER, STREAM_MAX_FRAMES, STREAM_VIDEO_MAX_SIZE, SHM_STREAM_READ, SHM_STREAM_MMAP);
...
int main()
{
	shm_stream_t* handle = shm_stream_create("read1", "stream", STREAM_MAX_USER, STREAM_MAX_FRAMES, STREAM_VIDEO_MAX_SIZE, SHM_STREAM_READ, SHM_STREAM_MMAP);
	if(handle == NULL)
	{
